...
export default function ReportsPage() {
  ...
  async function load(client: Supabase) {
    const { data, error } = await client.from('reports').select('*').order('created_at', { ascending: false }).limit(100);
